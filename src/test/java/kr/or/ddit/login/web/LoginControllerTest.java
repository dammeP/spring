...
public class LoginControllerTest extends WebTestConfig{
	...
	public void processSuccessTest() throws Exception{
		mockMvc.perform(post("/login/process")
				...
				.andExpect(status().is(200)).andExpect(view().name("main"))
	...
	public void processFailTest() throws Exception{
		MvcResult result =  mockMvc.perform(post("/login/process").param("userid", "brown").param("pass", "brownPassFail")).andReturn();
