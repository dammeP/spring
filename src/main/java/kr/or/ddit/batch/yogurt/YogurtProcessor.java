...
public class YogurtProcessor implements ItemProcessor<CycleVO, List<DailyVO>>{
	...
	// jobLauncher를 실행하면서 두번째 인자로 넣어준 jobParameter 값을 SPEI을 통해 주입
	// 단 jobParameters에 접근하기 위해서는 해당 스프링 빈의 scope를 step으로 지정해야한다
	@Value("#{jobParamegers[ym]}")
	private String ym="2020                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          11";
	...
	public List<DailyVO> process(CycleVO item) throws Exception {
		// 생성 월이 2020 11월
	      ...
	      // ==>
	      // cid=1, pid=100, day=20201102, cnt=3
	      // cid=1, pid=100, day=20201109, cnt=3
	      // cid=1, pid=100, day=20201116, cnt=3
	      // cid=1, pid=100, day=20201123, cnt=3
	      // cid=1, pid=100, day=20201130, cnt=3
	      ...
	      while(endTimeInt >= dtInt) {
	    	 ...
	    	 // calender 날짜가 item의 애음요일과 같을 때만 dailyVO를 생성
